...
from ..openai_compatible_client import ChatCompletion, ChatCompletionChunk
from ..openai_compatible_client._types import CompletionUsage


def map_usage(response: ChatCompletion | ChatCompletionChunk) -> RequestUsage:
...
def _usage_details(raw_usage: CompletionUsage) -> dict[str, int]:
